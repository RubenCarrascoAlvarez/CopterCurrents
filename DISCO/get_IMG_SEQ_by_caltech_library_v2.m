...
%   DISCO.
%  
%   If you want to retrieve the IMG_SEQ structure without any DISCO 
...
altitude = Height_drone + Georeference_Struct_config.offset_home2water_Z + ...
           Georeference_Struct_config.DISCO_CamCalib.camera_offset_Z;
...
% [~,conv_monotonic_grid_ST] = georeferenceDJIFrame_byCaltech_EQ(img_gray,altitude, pitch,roll,Georeference_Struct_config.DISCO_CamCalib);
[~,conv_monotonic_grid_ST] = georeferenceDJIFrame_byCaltech_EQ_v2(img_gray,altitude, pitch,roll,Georeference_Struct_config.DISCO_CamCalib);
