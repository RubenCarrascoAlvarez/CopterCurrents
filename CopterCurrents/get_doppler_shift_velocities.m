...
for jj = 1:numel(fit_param.wavenumbers)
    ...
    %%
     ...
     %figure(1002);imagesc(fit_param.Uy_2D(1,:),fit_param.Ux_2D(:,1),snrG);colorbar;axis image;drawnow;
...
SNR_fit = k_cylinder_nsp(Spectrum,P,wavenumbers(jj),Ufit(1),Ufit(2),Scyl,fit_param.include2ndHarmonic,fit_param.logFlag);
