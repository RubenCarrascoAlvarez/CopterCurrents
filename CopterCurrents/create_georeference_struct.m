...
%                          in meters. [0]
%     CopterCurrents_calibration_filename: filename with the calibration parameters.
%     CamPos_ST: Camera position Structure defining the extrinsic
%     parameters.
%
%   Output:
...
%                                                structure.   
%     Georeference_Struct_config.CamPos_ST: Camera position Structure defining 
...
Georeference_Struct_config.CamPos_ST = CamPos_ST;
