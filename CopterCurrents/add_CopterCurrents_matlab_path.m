...
% get all the folders in the CopterCurrents path
CopterCurrents_main_path = [pwd filesep];
paths2add_str = genpath(CopterCurrents_main_path);
...
paths2add_str_clean = [CopterCurrents_main_path genpath_char];
