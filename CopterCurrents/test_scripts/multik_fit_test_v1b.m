...
video_fname = '/media/4TB_NTFS_disk1/CopterCurrents-master/videos/4d/DJI_0002.MP4';
...
print('-dpng','Window_used_n2_v1b.png');
...
set(findall(gcf,'-property','FontSize'),'FontSize',16);
print('-dpng','Depht_fit_Wind_and_current_opposite_dir_v1b.png');

close all
save('multik_fit_test_v1b.mat','-v7.3','-nocompression')
