%
% This script process the video '20170404_over_Elbe.MP4': 
% 
...
%
% The Georeferencing method is describeb in the Caltech library.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
CopterCurrents_calibration_filename = '/media/d1/Drone_current_fit/githup/CopterCurrents/CopterCurrents/CopterCurrents_CameraCalib/Phantom3_v1_OpenCV_3840x2160.mat';
