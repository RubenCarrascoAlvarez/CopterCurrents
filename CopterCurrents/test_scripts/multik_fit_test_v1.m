...
time_limits = [52 76.20];
% time_limits = [0 0.15] + 50; % 12m
% time_limits = [0 0.15] + 52;
...
% CopterCurrents_calibration_filename = '/media/d1/Drone_current_fit/CopterCurrents-master/CopterCurrents/CopterCurrents_CameraCalib/Matrice210_v1_FOV_3840x2160.mat';
CopterCurrents_calibration_filename = '/media/d1/Drone_current_fit/CopterCurrents-master/CopterCurrents/CopterCurrents_CameraCalib/Matrice210_v1_Caltech_3840x2160.mat';
...
% waveLength_limits_m = []; 
% waveLength_limits_m = [0.15 sq_size_m/4]; 
waveLength_limits_m = [0.15 sq_size_m/5];
...
close all
save('multik_fit_test_v1.mat','-v7.3','-nocompression')
