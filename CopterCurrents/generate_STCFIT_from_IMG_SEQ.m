function STCFIT = generate_STCFIT_from_IMG_SEQ(IMG_SEQ, sq_size_m, sq_dist_m,...
...
Ux_SG_vec =  -U_FG_res:U_SG_res:U_FG_res;
Uy_SG_vec =  -U_FG_res:U_SG_res:U_FG_res;
...
% % generate STCFIT
% %%%%%%%%%%%%%%%%%
STCFIT = struct('Generic',Generic,'Windows',Windows,'fit_param',fit_param,'out_fit',out_fit);
